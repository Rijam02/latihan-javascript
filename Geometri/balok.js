...
let l = parseFloat(prompt("Masukkan lebar tabung: "));
let v = p * t * l;
...
let lebar = parseFloat(prompt("Masukkan lebar tabung: "));
...
let tgi = parseFloat(prompt("Masukkan tinggi tabung: "));
let lbr = parseFloat(prompt("Masukkan lebar tabung: "));
